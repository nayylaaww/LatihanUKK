...
if (isset($_POST['kembalikan'])) {
    ...
    $stmt = $conn->prepare("UPDATE peminjaman SET status = 'dikembalikan', tanggal_kembali = ?, denda = ?
WHERE id = ?");
    $stmt->bind_param("sdi", $tanggal_kembali, $denda, $id);

    if ($stmt->execute()) {
        logActivity($_SESSION['user_id'], "Mencatat pengebalian ID: $id");
        $message = showAlert('success', 'Penge,balian berhasil dicatat!');
    } else {
...
<head>
    ...
    <title>Pengembalian Alat-Petugas</title>
        ...
        <div class="modal-content">
            ...
            <form method="POST" id="kembalikanForm">
                ...
                <div class="form-group">
                    ...
                    <input type="date" name="tanggal_kembali" id="tanggalKembali" class="form-control" value="<?php echo date('Y-m-d'); ?>" required>
                </div>
